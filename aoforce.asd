(defsystem "aoforce"
  ...
  :components
  ((:module "source"
    :components ((:module "utils" ;; Establish first our toolbox
   ...
   ;; UI/X Frontends
   (:module "frontends"
    :components (#+sbcl (:file "gtk4-tutorial"))))
...
(defsystem "aoforce/docs"
  :depends-on ("aoforce" "3bmd" "colorize" "print-licenses")
  :components
  ((:module "docs"
    :components ((:file "aoforce-docs")))))
